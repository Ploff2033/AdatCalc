(function () {
  ...
  // Ни один цвет не должен совпадать/быть близким к var(--accent) (цвет
  // "Итого") или var(--positive)/var(--negative) — иначе линия завода
  // сливается с "Итого" или неверно читается как прибыль/убыток.
  var PLANT_COLORS = ['#3a6ea5', '#7a4a8a', '#2b8f8a', '#8a6a3f', '#5a5fb0', '#a5478a', '#6b8a2b', '#556270'];
